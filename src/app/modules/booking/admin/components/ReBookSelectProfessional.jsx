...
const ReBookSelectProfessional = ({
  selected_beautician,
  resources,
  setBookingDetail,
}) => {
  ...
  useEffect(() => {
    setBookingDetail("beautician", selected_beautician);
  }, [selected_beautician]);
              ...
              <Grid item xs={12} sm={6} lg={4} key={index}>
                <Card>
                  <ToggleButton
                    {...(!selecting && {
                      selected:
                        selected_beautician.filter((item) => {
                    ...
                    onClick={() => {
                      selecting = true;
                      setBookingDetail("beautician", [data]);
                    }}
                  >
...
export default ReBookSelectProfessional;
