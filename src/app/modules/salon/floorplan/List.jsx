...
export default function FloorplanList() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["floorplan", { gql: queryDocument(searchTerm, currentPage) }],
  ...
  return (
    ...
    >
      <JumboCard contentWrapper>
        ...
        <Typography variant={"h3"}>{t("Floorplan")}</Typography>
        <BListWrapper>
          <header>
            <BTHeaderWrapper>
              <Stack>
        ...
        <Stack>
          <ButtonGroup>
            <Button
              ...
              onClick={() => {
                navigate(`/salon/floorplan/${item.id}`);
              }}
            >
              Edit
            </Button>
            ...
            <Button
              ...
              color={item.isFollowing ? "error" : "primary"}
              onClick={() => {
                navigate(`/salon/floorplan/${item.id}/pos`);
              }}
            >
              PoS
            </Button>
