  ...
  return (
    ...
    >
      <JumboCard contentWrapper>
        ...
        <Typography variant={"h3"}>{t("Specializations")}</Typography>
        <BListWrapper>
          <header>
            <BTHeaderWrapper>
              <Stack>
              ...
              <Stack>
                <Link to={`/askdaysi/specializations/new`}>
                  <Button
                    variant={"contained"}
                    size={"small"}
                    color={"primary"}
        ...
        <Stack>
          <ButtonGroup>
            <Button
              ...
              onClick={() => {
                queryClient.invalidateQueries({
                  queryKey: ["single_specialization"],
                });
                navigate(`/askdaysi/specializations/${item.id}`);
              }}
            >
              Edit
            </Button>
