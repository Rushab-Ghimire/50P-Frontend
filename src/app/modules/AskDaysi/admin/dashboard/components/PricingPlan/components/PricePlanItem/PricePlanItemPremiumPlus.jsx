...
import { FeaturesListPremium, FeaturesListPremiumPlus } from "../FeaturesList";
import PropTypes from "prop-types";

const PricePlanItemPremiumPlus = ({
  title,
  subheader,
  children,
  headerSx,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FeaturesListPremiumPlus />
      </CardContent>
    </Card>
  );
};

export { PricePlanItemPremiumPlus };

PricePlanItemPremiumPlus.propTypes = {
