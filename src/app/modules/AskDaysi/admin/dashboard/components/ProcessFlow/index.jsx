...
import ADProcessSelector from "../../dialogs/ADProcessSelector";
...
const ADProcessFlowDesign = () => {
  ...
  return (
    <>
      {isAdding && (
        <ADProcessSelector handleClose={closeProcessModal} handle={handleAdd} />
      )}
...
export default ADProcessFlowDesign;
