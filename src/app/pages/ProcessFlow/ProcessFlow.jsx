...
const ProcessFlow = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["processflow", { gql: queryDocument(searchTerm, currentPage) }],
          ...
          <Stack>
            <form onSubmit={handleSubmit} id="search-form">
              <TextField
                ...
                placeholder="Search Process Flow"
              />{" "}
              <Button
                type="submit"
                variant="contained"
        ...
        <Stack>
          <ButtonGroup>
            ...
            <Button
              ...
              onClick={() => navigate(`/processflow-design/${item.id}`)}
            >
              Design
            </Button>
          </ButtonGroup>
